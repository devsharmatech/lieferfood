...
@section('vendor_body')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">New Table Food</span> </h4>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('vendor.store-table.food') }}">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" value="{{ old('price') }}" step="0.01" type="number" name="price"
                                        id="price" />
                                    @error('price')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <input class="form-control" type="number" value="{{ old('prep_time') }}"
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <select id="is_vegetarian" name="is_vegetarian" class="select2 form-select">
                                        ...
                                        <option value="1" @selected(old('is_vegetarian') == 1)>Yes</option>
                                        <option value="0" @selected(old('is_vegetarian') == 0)>No</option>
                                    </select>
                                    @error('is_vegetarian')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <select id="is_spicy" name="is_spicy" class="select2 form-select">
                                        ...
                                        <option value="1" @selected(old('is_spicy') == 1)>Yes</option>
                                        <option value="0" @selected(old('is_spicy') == 0)>No</option>
                                    </select>
                                    @error('is_spicy')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
