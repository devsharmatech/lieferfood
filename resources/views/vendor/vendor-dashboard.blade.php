                    ...
                    <div class="d-flex flex-column flex-md-row align-items-end">
                        <div class="col-md-7 col-12 order-2 order-md-1">
                            <div class="card-body">
                                ...
                                <a href="{{route('vendor.my.profile')}}" class="btn btn-sm btn-outline-primary">Edit Profile</a>
                            </div>
                        </div>
...
<div class="col-12">
    <div class="row state">
        ...
        <div class="col-6 col-md-3 mb-4">
            <a href="{{ route('vendor.all.orders') }}" class="card-link">
        ...
        {{-- Pending Orders --}}
        <div class="col-6 col-md-3 mb-4">
            <a href="{{ route('vendor.all.orders',['status'=>'pending']) }}" class="card-link">
                <div class="card h-100 card-hover">
                    <div class="card-body text-center">
        ...
        {{-- Cancelled Orders --}}
        <div class="col-6 col-md-3 mb-4">
            <a href="{{ route('vendor.all.orders',['status'=>'cancelled']) }}" class="card-link">
                <div class="card h-100 card-hover ">
                    <div class="card-body text-center">
        ...
        {{-- Delivered Orders --}}
        <div class="col-6 col-md-3 mb-4">
            <a href="{{ route('vendor.all.orders',['status'=>'delivered']) }}" class="card-link">
                <div class="card h-100 card-hover">
                    <div class="card-body text-center">
                        <div class="icon-box mx-auto bg-success">
        ...
        {{-- Delivery Orders --}}
        <div class="col-6 col-md-3 mb-4">
            <a href="{{ route('vendor.all.orders',['method_type'=>'delivery']) }}" class="card-link">
                <div class="card h-100 card-hover">
                    <div class="card-body text-center">
                        <div class="icon-box mx-auto bg-info">
                            <i class="fa-solid fa-truck-fast"></i>
        ...
        {{-- Pickup Orders --}}
        <div class="col-6 col-md-3 mb-4">
            <a href="{{ route('vendor.all.orders',['method_type'=>'pickup']) }}" class="card-link">
                <div class="card h-100 card-hover">
                    <div class="card-body text-center">
                        <div class="icon-box mx-auto bg-info">
        ...
        {{-- Restaurant Orders --}}
        <div class="col-6 col-md-3 mb-4">
            <a href="{{ route('vendor.table.bookings') }}" class="card-link">
                <div class="card h-100 card-hover">
                    <div class="card-body text-center">
                        <div class="icon-box mx-auto bg-info">
