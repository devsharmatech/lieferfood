            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-header py-0">Areas List</h5>
                            ...
                            <tbody>
                                @foreach ($areas as $area)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('vendor.edit.delivery-area', $area->id) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-6" id="staticBackdropLabel">Add Delivery Area</h1>
                ...
                <form method="post" id="addNewPostcode" class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="postcode" name="postcode" placeholder="299393">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="area_name" name="area_name" placeholder="Area or street names">
                        </div>
                        <div class="col-md-6 mb-3">
    ...
    <script>
        $(document).ready(function() {
            $('#addNewPostcode').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route('vendor.save.delivery-area') }}',
                    type: 'POST',
                    data: formData,
                    success: function(response) {
                        ...
                        if (response.status === false) {
                            ...
                            toastr.success('Postcode added successfully!');
        ...
        $(document).ready(function() {
            $('.delete-record').on('click', function(e) {
                ...
                if (confirm("Are you sure you want to delete this record?")) {
                    var deleteUrl = "{{ route('vendor.delete.delivery-area') }}/" + recordId;
                    $.ajax({
                        url: deleteUrl,
                        type: 'DELETE',
                        data: {
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.update-status').on('change', function() {
                ...
                // AJAX request
                $.ajax({
                    url: '{{route("vendor.update.delivery-area-status")}}',
                    type: 'POST',
                    data: {
                        _token: '{{csrf_token()}}', 
                        id: recordId,
