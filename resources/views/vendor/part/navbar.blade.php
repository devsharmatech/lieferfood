    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        <div class="d-flex">
            <div class="mt-2 me-4 text-center d-md-block d-none">
                ...
                <div class="form-check form-switch mb-2 " style="cursor: pointer;">
                    <input class="form-check-input vendor_detail_al" type="checkbox" data-id="{{ auth()->user()->id }}"
                        data-key="restaurant_status" @checked(isset(auth()->user()->vendor_details->restaurant_status) && auth()->user()->vendor_details->restaurant_status == 1) id="status_restaurant" />
                </div>
            </div>
            <div class="mt-2 me-4 text-center  d-md-block d-none">
                ...
                <div class="form-check form-switch mb-2" style="cursor: pointer;">
                    <input class="form-check-input vendor_detail_al" type="checkbox" data-id="{{ auth()->user()->id }}"
                        data-key="isDelivery" @checked(isset(auth()->user()->vendor_details->isDelivery) && auth()->user()->vendor_details->isDelivery == 1) id="isDelivery" />
                </div>
            </div>
            <div class="mt-2 me-4 text-center  d-md-block d-none">
                <small>📦 Pickup</small>
                <div class="form-check form-switch mb-2" style="cursor: pointer;">
                    <input class="form-check-input vendor_detail_al" type="checkbox" data-id="{{ auth()->user()->id }}"
                        data-key="isPickup" @checked(isset(auth()->user()->vendor_details->isPickup) && auth()->user()->vendor_details->isPickup == 1) id="isPickup" />
                </div>
            </div>
            <div class="mt-2 text-center  d-md-block d-none">
                ...
                <div class="form-check form-switch mb-2" style="cursor: pointer;">
                    <input class="form-check-input vendor_detail_al" type="checkbox" data-id="{{ auth()->user()->id }}"
                        data-key="isTable" @checked(isset(auth()->user()->vendor_details->isTable) && auth()->user()->vendor_details->isTable == 1) id="isTable" />
                </div>
            </div>
            <div class="mt-2 mx-2 text-center ">
                <button class="btn btn-primary" type="button" id="fetchLocation" data-bs-toggle="modal"
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item me-3">
                <button class="btn btn-light" id="countryLangButton" data-bs-toggle="modal"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="addressInput" class="form-control" value="{{Auth::user()->address ?? ''}}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="manualLatitude" value="{{Auth::user()->latitude ?? ''}}"
                        placeholder="e.g. 28.123456">
                </div>

                <div class="mb-3">
                    <label for="manualLongitude" class="form-label">Longitude</label>
                    <input type="text" class="form-control" id="manualLongitude"
                        value="{{Auth::user()->longitude ?? ''}}" placeholder="e.g. 77.123456">
                </div>
