...
.address-card:hover .card-body {
    border: 2px solid rgba(0, 128, 0, 0.5); /* greenish hover */
    border-radius: 0.5rem;
}
...
@section('external-home-content')
    <section class="py-0 ">
        @php
    $sessionLocation = trim((session('street') ? session('street') . ' ' : '') 
...
@endphp
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="text-uppercase text-sm-start text-center fw-bold">
                                        <i class="fas fa-map-marker-alt text-danger me-2"></i> {{ $method == 'delivery' ? 'All' : 'Pickup' }} Address</h5>
                                </div>
                                <hr>
                                <input type="hidden" name="method_type"  value="{{ $method == 'delivery' ? 'delivery' : 'pickup' }}">
                                @if ($method == 'delivery')
                                    <div class="col-12">
                                        <div class="accordion" id="accordionExample">
                                            <div class="accordion-item ">
                                                <h2 class="accordion-header" id="headingOne">
                                                    <button class="accordion-button text-white fs-1 fw-bold" style="background:gray;" type="button"
    ...
    <label class="address-card card position-relative w-100">
        <input type="radio" name="old_address" class="card-input old_address" value="{{ $oldAddress->id }}" 
        ...
        <div class="card-body  p-2 w-100 ">
            ...
            <p class="card-text fw-bold" style="word-break:break-all !important;">
    ...
    <div class="text-start" style="margin-left:10px;" >
                                                                           <i style="cursor:pointer;" class="fa-solid fa-trash text-danger text-start  delete-address" 
                                                                            data-id="{{ $oldAddress->id }}" title="Delete Address"></i>
                                                                       </div> 
...
<div class="row mt-2">
    ...
    <div class="input-group position-relative rounded-pill">
        <input type="text" class="form-control home-search-input fw-bold py-3" style="padding-left:1rem !important; -webkit-appearance: textfield;height:56px !important;font-size:1.4rem;color:#000 !important;"
            placeholder="Please give your postcode, city or area name." id="place-input" name="location"
             autocomplete="off" />
        ...
        <button class="btn btn-primary home-search-button text-white disabled" disabled id="search-loc"
            > <i class="fa-solid fa-location-dot"></i></button>
    </div>
    <div class="text-center position-relative mt-2 card py-1 rounded-pill">
        <span id="getMyAddress" style="cursor:pointer; color:red; font-size:1.4rem;">
            <i class="fa-solid fa-location-crosshairs mx-2 " ></i> Click here get current location
        </span>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            <label for="street" class="fw-bold">Street <span class="text-danger">*</span></label>
            <input type="text" id="street" name="street" class="form-control form-control-lg" value="{{session('street')}}" placeholder="Street" readonly>
            @error('street')
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <input type="text" id="house_number" name="house_number"
                   class="form-control form-control-lg" placeholder="House Number" value="{{session('street_number') ?? null}}" required>
            @error('house_number')
               <small class="text-danger">{{$message}}</small>
            @enderror
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            <label for="postal_code" class="fw-bold">Postal Code <span class="text-danger">*</span></label>
            <input type="text" id="postal_code" name="postal_code"
                   class="form-control form-control-lg" placeholder="Postal code" value="{{session('postcode')}}" readonly>
            <input type="hidden" id="latitude" name="latitude"  value="{{session('latitude')}}" readonly>
            <input type="hidden" id="longitude" name="longitude"  value="{{session('longitude')}}" readonly>
            @error('postal_code')
               <small class="text-danger">{{$message}}</small>
            @enderror           
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            <label for="city" class="fw-bold">City <span class="text-danger">*</span></label>
            <input type="text" id="city" name="city"
                   class="form-control form-control-lg" placeholder="City"  value="{{session('city')}}" readonly>
            @error('city')
               <small class="text-danger">{{$message}}</small>
            @enderror
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <input type="text" id="city_district" name="city_district" class="form-control form-control-lg" value="{{session('sublocality')}}" placeholder="City District.." readonly>
             @error('city_district')
               <small class="text-danger">{{$message}}</small>
            @enderror
        </div>
    ...
    <div class="col-md-6">
    <div class="form-group mb-3">
        <label for="floor" class="fw-bold">Building storey <span class="text-danger">*</span></label>
...
@endfor
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
                                        <label for="phone" class="fw-bold">Please select your delivery/pickup time</label>
    ...
    <div class="col-md-12">
        <div class="form-check mb-3">
            <input type="checkbox" class="form-check-input" id="save_details_next" name="save_details_next">
            <label for="save_details_next" class="form-check-label fw-bold">Do you want to save this address?</label>
        </div>
            ...
            <h6 class="mt-3 fs-1"><strong><i class="fas fa-map-marker-alt me-2"></i> Address:</strong></h6>
            <h6 class="mt-3 fs-1"><strong><i class="fa-solid fa-shop me-2"></i>{{$vendor->name}}</strong></h6>
            <p class="mb-1 fs-1">
                @isset($restDetails)
            ...
            <!-- Contact Information -->
            <h6 class="mt-3 fs-1"><strong><i class="fas fa-tty me-2"></i> Contact Information:</strong></h6>
            <p class="mb-1 fs-1">
                @isset($vendor->phone)
            ...
            <p class="mb-1 fs-1">
              <i class="fas fa-globe me-2"></i> Url: <a class="text-primary" target="_blank" href="{{$restDetails->shop_url}}">{{$restDetails->shop_url}}</a>
            </p>
                                            </div>
                                            <div class="card-body">
                                                <iframe
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea id="note" name="note" rows="1" class="form-control form-control-lg" placeholder="Note"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" id="first_name" name="first_name" class="form-control form-control-lg"
                                        placeholder="First Name" value="{{ isset($name[0]) ? $name[0] : '' }}">
                                    @error('first_name')
                                        <small class="text-danger"> {{ $message }} </small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="phone" class="fw-bold">Phone Number <span class="text-danger">*</span></label>
    ...
    <div class="payment-methods d-flex flex-wrap justify-content-center justify-content-md-start gap-3">
        ...
        <label class="payment-card" for="debit_card_at_home">
            <input type="radio" name="paymentMethod" id="debit_card_at_home" value="card_payment">
            <div class="card-content shadow-sm">
                <div class="checkmark">
                    <svg viewBox="0 0 24 24">
                        <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
                                            ...
                                            <li class="w-100">
                                                <div class="d-flex flex-column w-100">
                                                    ...
                                                    <div class="d-flex justify-content-between w-100  align-items-center">
                                                        <h6 class="mb-0 " style="font-size:16px;">{{ $cart->quantity }} <span class="text-muted">x</span> {{ $foodName }} :
                                                            {{ $variantName }}</h6>
                                                        <span class="fw-bold"
...
@endphp
   ...
   id="showMoreBtn_{{ $loop->index }}"
   onclick="toggleItems('combinedItems_{{ $loop->index }}', 'showMoreBtn_{{ $loop->index }}')"
   data-state="collapsed"
   style="cursor:pointer;font-size:15px;">+ Show More</a>
                                        ...
                                        @endforeach
                                        <hr>
                                        <li class="fw-bold"><strong>Sub Total </strong> <span>{{ number_format($totalPrice, 2) }}€</span>
                                        </li>
                                        @if($totalDiscount>0)
                                          <li class="fw-bold"><strong>Discount </strong> <span class="text-success">-{{ number_format($totalDiscount, 2) }}€</span>
                                          </li>
                                        @endif
                                ...
                                <div class="col-12 ">
                                    <div class="d-flex align-items-center ">
                                        ...
                                        <label for="accept_terms_condition" class="ms-2 mb-0">I accept the terms & conditions and privacy policy.</label>
                                    </div>
                                ...
                                @else
                                   <span class="text-danger w-100 text-center btn btn-light disabled fw-bold">Delivery not available</span>
                                @endif
                            </div>
                        </div>
                    </div>
