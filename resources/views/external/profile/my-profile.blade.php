...
@section('external-home-content')
    <section class=" pb-2 pt-3 container-fluid overflow-hidden ">
        <div class="row mb-5">
            <div class="col-12">
                <h3 class="fw-bold text-center mb-2">My Account</h3>
            </div>
            <div class="col-md-4">
                <div class="card rounded-1 border-0 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <h3 class="text-center fw-bold text-uppercase"> {{ $user->name . ' ' . $user->surname }} </h3>
                        <ul class="mt-2 list-unstyled profile-info">
                            <li>
                                <span class="fw-bold">
                                    <i class="fa fa-phone-square-alt text-primary me-1" aria-hidden="true"></i>
                                    Phone:
                                </span>
            ...
            <div class="col-md-8">
                <div class="card rounded-1 border-0">
                    <div class="card-body">
                        <ul class="nav nav-pills profiletab mb-3" id="pills-tab" role="tablist">

                            <li class="nav-item ">
                                <a href="{{ route('myaccount') }}?opt=profile"
                                    class="nav-link @if (isset($_GET['opt']) && $_GET['opt'] == 'profile') active @elseif(!isset($_GET['opt'])) active @endif rounded-1">Profile</a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{ route('myaccount') }}?opt=address"
                                    class="nav-link rounded-1 @if (isset($_GET['opt']) && $_GET['opt'] == 'address') active @endif">Address</a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{ route('myaccount') }}?opt=orders"
                                    class="nav-link rounded-1 @if (isset($_GET['opt']) && $_GET['opt'] == 'orders') active @endif">Orders</a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{ route('myaccount') }}?opt=table_booking"
                                    class="nav-link rounded-1 @if (isset($_GET['opt']) && $_GET['opt'] == 'table_booking') active @endif">Table
                                    Booking</a>
                            </li>
<!-- Add the Notifications tab to the nav pills -->
<li class="nav-item ">
    <a href="{{ route('myaccount') }}?opt=notifications"
        class="nav-link rounded-1 @if (isset($_GET['opt']) && $_GET['opt'] == 'notifications') active @endif">Notifications</a>
</li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade @if (isset($_GET['opt']) && $_GET['opt'] == 'profile') show active @elseif (!isset($_GET['opt'])) show active @endif"
                                ...
                                <form method="post" enctype="multipart/form-data"
                                    action="{{ route('update.my.account') }}" class="mt-3 row">
                                    @csrf
                                    <div class="col-12">
                                        <h5 class="text-center fw-bold">Edit Profile</h5>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control px-2" id="surname" name="surname"
                                            value="{{ $user->surname }}">
                                        @error('surname')
                                            <small class="text-danger"> {{ $message }} </small>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="email" class="form-control px-2" id="email" name="email"
                                            value="{{ $user->email }}">
                                        @error('email')
                                            <small class="text-danger"> {{ $message }} </small>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="phone" class="form-control px-2" id="phone" name="phone"
                                            value="{{ $user->phone }}">
                                        @error('phone')
                                            <small class="text-danger"> {{ $message }} </small>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control px-2" id="password" name="password">
                                        @error('password')
                                            <small class="text-danger"> {{ $message }} </small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="file" class="form-control px-2" id="file" name="image">
                                        @error('image')
                                            <small class="text-danger"> {{ $message }} </small>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <textarea class="form-control px-2" id="address" name="address" value="">{{ $user->address }}</textarea>
                                        @error('address')
                                            <small class="text-danger"> {{ $message }} </small>
                                        @enderror
                                    </div>
                            ...
                            <div class="tab-pane fade @if (isset($_GET['opt']) && $_GET['opt'] == 'address') show active @endif"
                                ...
                                <form method="post" action="{{ route('update.my.address') }}" class="mt-3 row">
                                    @csrf
                                    <div class="col-12">
                                        <h5 class="text-center fw-bold">Update Address</h5>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="country" class="form-label">Country</label>
                                        <select class="form-control px-2" id="country" name="country">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control px-2" id="city" name="city"
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control px-2" id="postal_code"
                                            name="postal_code"
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control px-2" id="neighborhood"
                                            name="neighborhood"
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control px-2" id="street" name="street"
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control px-2" id="house_number"
                                            name="house_number"
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control px-2" id="complement"
                                            name="complement"
    ...
    <div class="order-list-container">
        ...
        @endforelse
                            ...
                            <div class="tab-pane fade @if (isset($_GET['opt']) && $_GET['opt'] == 'table_booking') show active @endif"
                                ...
                                @forelse ($tables as $table)
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p class="mb-0"><strong> Restaurnat : </strong>
                                                        {{ $table->vendor->name }}
                                                    </p>
                                                    <p class="mb-0"><strong> Visit Date : </strong>
                                                        {{ date('d F Y', strtotime($table->table_date)) }}</p>
                                                    <p class="mb-0"><strong> Visit Time : </strong>
                                                        {{ date('h:i A', strtotime($table->slot_time)) }}</p>
                                                    <p class="mb-0"><strong> Food Type : </strong>
                                                        {{ $table->food_type }}</p>
                                                ...
                                                <div class="col-md-6">
                                                    <h6 class="text-primary fw-bold fs-1">Food Menu</h6>
                                                    <ol>
                                                    ...
                                                    <div class="border-1 p-2">
                                                        @if (isset($table->offer) && json_decode($table->offer) != null)
                                                            ...
                                                            <ol>
                                                                ...
                                                                <li><strong>Offer Available Upto:</strong>
                                                                    {{ $offer->upto_price }}</li>
                                                ...
                                                <p
                                                    class="mb-0 d-flex justify-content-between flex-wrap w-100 align-items-center">
                                                    <strong>Booking Status : </strong>
                                                    @if ($table->status == 'pending')
                                                        <button class="btn btn-sm btn-primary"
                                                            onclick="cancelBook({{ $table->id }})">Cancel</button>
                                                        <br>
                                                        <span class="badge bg-info rounded-0">Pending</span>
                                                    @elseif ($table->status == 'accept')
                                                        <button class="btn btn-sm btn-primary"
                                                            onclick="cancelBook({{ $table->id }})">Cancel</button>
                                                        <br>
                                                        <span class="badge bg-success rounded-0">Accept</span>
                                                    @elseif ($table->status == 'reject')
                                                        <span class="badge bg-danger rounded-0">Reject</span>
                                                    @elseif ($table->status == 'cancelled')
                                                        <span class="badge bg-danger rounded-0">Cancelled</span>
                                                    @endif
                                                </p>
                                            </div>
                                        </div>
                                ...
                                @empty
                                    <h5 class="text-danger fw-bolder mt-3">Empty!</h5>
                                @endforelse
                            </div>
