<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
    <div class="container-fluid">
        ...
        <div class="d-flex">
            <a href="" class="btn btn-light d-md-flex align-items-center d-none">
                The Inside Track
            </a>
            <button class="country-btn" id="countryLangButton" data-bs-toggle="modal" data-bs-target="#countryLangModal">
                <img src="https://flagcdn.com/256x192/us.png" id="currentFlag" alt="Country Flag">
            </button>
            <button class="btn btn-white text-dark" data-bs-toggle="modal" data-bs-target="#staticBackdrop" type="button">
