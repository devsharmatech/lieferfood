<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
    <div class="container-fluid">
        ...
        <div class="d-flex">
            <a href="{{route('admin.login')}}" class="btn btn-light d-md-flex align-items-center d-none">
                <i class="fa me-2 fa-user"></i> Admin Log in
            </a>
            <a href="{{route('paying-card')}}" class="btn btn-light d-md-flex align-items-center d-none">
                Cards
            </a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row ">
                    ...
                    <div class="col-md-12 ">
                        <a href="{{ route('myaccount') }}?opt=orders" class="btn btn-light text-start fw-bold text-dark fs-1 w-100 mt-3 ">
                            <i class="fa-solid fa-bag-shopping me-2"></i>
                            Order
                        </a>
                        <a href="#" class="btn btn-light d-none text-start fw-bold text-dark fs-1 w-100 mt-1">
                        ...
                        <a href="#" class="btn btn-light d-none align-items-center text-start fw-bold text-dark fs-1 w-100 mt-1">
