            ...
            <div class="col-md-10">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Food Category</h5>
                        <small class="text-muted float-end">Edit Food Category</small>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.update.food.category') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6 d-flex ">
                                    <div class="mb-3 me-3">
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" name="discount" @checked($category->discount == 1) type="checkbox"
                                                id="discount" />
