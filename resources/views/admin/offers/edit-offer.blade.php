        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.update.offer') }}">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    <label for="image" class="form-label">Image (400x1000px)</label>
                                    ...
                                    @enderror
                                    <div class="mt-3">
                                        <img src="{{ asset('uploads/offer/' . $offer->image) }}" style="height: 4rem"
                                            alt="">
                                    </div>
                                </div>
