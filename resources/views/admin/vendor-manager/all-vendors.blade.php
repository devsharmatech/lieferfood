            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.create.vendor') }}" class="btn btn-sm btn-secondary ">Add New</a>
                    </div>
                    <div class="card-body">
                                ...
                                @foreach ($users as $key => $vendor)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.impersonate', $vendor->id) }}" method="POST">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-primary">Dashboard</button>
                                            </form>

                                        </td>
                                        <td>
                                            <a href="{{ route('vendors.permissions', $vendor->id) }}"
                                                class="btn btn-sm btn-primary">Permission</a>
                                        </td>
