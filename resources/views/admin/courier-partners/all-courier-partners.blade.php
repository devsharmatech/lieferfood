...
@section('title')
    Admin Dashboard (Courier Partners)
@endsection
@section('admin_body')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-header py-0">Courier Partners</h5>
                        <a href="{{route('add.courier.partner')}}" class="btn btn-primary btn-sm">Add New</a>
                    </div>
                    <div class="card-body">
                                ...
                                @foreach ($users as $key => $customer)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('view.courier.application', $customer->id) }}"
                                                class="text-success">
                                                <i class="bx bx-edit"></i> 
                                            </a>
                                            <a href="{{ route('delete.courier.application', $customer->id) }}" id="delete"
                                                class="text-danger">
