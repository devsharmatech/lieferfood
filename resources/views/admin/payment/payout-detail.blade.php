            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class=" py-0">Payout Details</h5>
                    </div>
                            ...
                            <tbody>
                                @foreach ($payouts as $payout)
                                    <tr>
                                        ...
                                        <td>
                                            <a target="_blank" href="{{ route('admin.show.vendor', $vendor->id) }}" class="btn btn-sm btn-info">{{ $payout->vendor->name ?? '' }}</a>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('admin.show.payout', $payout->id) }}" class="btn btn-sm btn-primary me-2">
                                                    Detail
                                               </a>
                                                <a href="{{ route('admin.show.payout', $payout->id) }}" class="btn btn-sm btn-danger">
                                                    Delete
                                               </a>
                                            </div>
